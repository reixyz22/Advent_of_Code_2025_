...
def main(file: str, option: str):
    ...
    with open(file, "r", encoding="utf-8") as f:  # reading the input
        ...
        if option == "Test1":
            test_output = []
            with open("../tests/day_2_test_answers.txt", "r", encoding="utf-8") as f:  # reading the test answers
                for line in f:
...
if __name__ == "__main__":
    main("../inputs/day_2.txt", "Full")
    main("../tests/day_2_test.txt", "Test1")
    #main("../tests/day_2_test_1_to_9999999.txt", "Test2")
